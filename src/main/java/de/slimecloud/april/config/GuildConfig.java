...
import de.slimecloud.april.config.engine.CategoryInfo;
import de.slimecloud.april.config.engine.ConfigField;
import de.slimecloud.april.config.engine.ConfigFieldType;
import de.slimecloud.april.features.april.AprilConfig;
import de.slimecloud.april.main.Main;
...
public class GuildConfig {
	...
	@CategoryInfo(name = "April-Scherz", command = "april", description = "April-Scherz Konfiguration")
	private AprilConfig april;
	...
	@NotNull
	public Optional<AprilConfig> getApril() {
		return Optional.ofNullable(april);
	}
